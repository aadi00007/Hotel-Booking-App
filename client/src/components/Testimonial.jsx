...
const Testimonial=()=>{
    return(
        <div>   
            <Title title='What our guests say' subtitle='Discover why travellers always choose QuickStay for their exclusive and luxurious accomodations around the globe.' />
