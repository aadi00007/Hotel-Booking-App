...
const Hero =()=>{
    ...
    return(
        ...
        className='hover:bg-white text-gray-500 rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
                ...
                <input onChange={(e)=> setdestination(e.target.value)} list='destinations' id="destinationInput" type="text"
